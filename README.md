...
为了深入了解系统架构与算法实现，请参考以下详细文档：

- **[架构设计文档](docs/ARCHITECTURE.md)**: 系统分层、数据流转与技术选型。
- **[核心算法文档](docs/ALGORITHMS.md)**: 模型辨识、PID 整定逻辑与仿真验证。
- **[业务模块文档](docs/MODULES.md)**: API 路由、Service 服务层与 DAO 数据访问层详解。
- **[开发与部署指南](docs/DEVELOPMENT.md)**: 环境配置、数据库迁移、测试与部署流程。
