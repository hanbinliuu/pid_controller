...
class SystemIdentifier:
    ...
    @staticmethod
    def identify( t,y, u, model_type='fopdt'):
        """最小二乘优化的残差函数"""
        if model_type == 'first_order': #一阶模型
            K,T,L = SystemIdentifier.identify_first_order(t, y, u)
        else: # FOPDT模型
            K,T,L  = SystemIdentifier.identify_fopdt(t, y, u)
        return K,T,L
