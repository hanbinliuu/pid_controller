    ...
    try:
        ...
        return {
            ...
            "data": {
                ...
                "tuning_method": evaluation.tuning_method,
                "tuning_time": evaluation.tuning_time.isoformat() if evaluation.tuning_time else None,
...
@router.get("/loop-evaluation/by-uri/{loop_uri:path}",
                ...
                "evaluations": [
                    {
                        ...
                        "tuning_time": e.tuning_time.isoformat() if e.tuning_time else None,
...
async def list_loop_evaluations(
    ...
    tuning_method: Optional[str] = Query(None, description="整定方法"),
