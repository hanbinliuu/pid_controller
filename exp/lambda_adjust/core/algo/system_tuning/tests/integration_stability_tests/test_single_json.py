...
def detect_and_visualize(json_file_path, output_path=None, tol=0.5, std_tol=0.2):
    ...
    t, t_original, pv, mv, sv = load_json(json_file_path)
...
if __name__ == "__main__":
    ...
    JSON_FILE_PATH = '/Users/lhb/Documents/pycharmProject/hollicube/pid-agent-mvp/exp/lambda_adjust/data_simulation/zhongkong/response_1761644174772.json'
    OUTPUT_PATH = None
